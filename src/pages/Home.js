  ...
  return (<div className="home_page_all">
    ...
    <section className="teaser-sec" style={{ height: "max-content ", overflowX: "hidden" }}>
      <div className=" h-[100vh] pt-32 pl-24 flex gap-20 items-center teaserr">
        ...
        <iframe className=" h-[60vh] aspect-video" src="https://www.youtube.com/embed/R-R5iclybq0?autoplay=1&mute=1" title="ANUGOONJ 2023 Teaser" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        </div>
