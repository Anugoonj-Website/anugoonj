  ...
  return (
    ...
    <div className="events">
      ...
      <div className="sponsors_content">
          ...
          <p className="sponsors_paragraph font-bold">
              Entry Time: 9:00 AM to 4:00 PM
          </p>
          <button className="update_button"> <a href="http://www.ipu.ac.in/dsw_anugoonj.php" target="_blank" rel="noopener noreferrer">Click here for further Updates</a> </button>
      </div>
