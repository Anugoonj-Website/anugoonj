  ...
  return (
    <div className='right_event_body'>
      ...
      <div className='right_poster_container'>
        <img src={`https://res.cloudinary.com/dyusmsyij/image/upload/w_1000,ar_1:1,c_fill,g_auto,e_art:hokusai/v1677436282/images/events_poster/${data.poster_url}`}  className="right_posters" />
      </div>
